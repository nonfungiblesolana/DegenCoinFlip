        ...
        <div className="play step1 text-start mt-md-5 pt-md-5 pt-4">
          ...
          <div className="container marketing">
            ...
            <div className="row featurette">
              <div className="col-md-12">
                ...
                <p className="lead">
                  ...
                  <br />
                  <br />
                  <a href="https://bughunters.google.com/" target="_blank">The Google Bug Hunters University guide</a> may be useful in considering whether an issue has security impact.
            ...
            <div className="row featurette">
              <div className="col-md-12 row">
                ...
                <div className="col-lg-4">
                  ...
                  <p className="lead">building a work-coordination protocol on Solana <a href="https://twitter.com/search?q=%23riptide&src=hashtag_click" target="_blank">#riptide</a> hackathon submission: <a href="https://twitter.com/cambrian_dev" target="_blank">@cambrian_dev</a></p>
                  <p className="lead"><a className="btn btn-twitter" href="https://twitter.com/joebuild" role="button" target="_blank">@joebuild »</a></p>
                </div>
                <div className="col-lg-4">
                  ...
                  <p className="lead">dev <a href="https://twitter.com/hxronetwork" target="_blank">@hxronetwork</a>, previously <a href="https://twitter.com/Google" target="_blank">@Google</a></p>
                  <p className="lead"><a className="btn  btn-twitter" href="https://twitter.com/fauxfire_" role="button" target="_blank">@fauxfire_ »</a></p>
                </div>
                <div className="col-lg-4">
                  <img className="rounded-circle" src="https://i.imgur.com/0CAy9oP.png" alt="Generic placeholder image" width="140" height="140" />
                  <h2 className="featurette-heading mt-2">Anon Dev</h2>
                  <p className="lead">Coming soon...</p>
                  {/* <p className="lead"><a className="btn btn-dark text-light bg-twitter-blue" href="#" role="button" target="_blank">Start Hacking Today »</a></p> */}
                </div>
              </div>
            </div>
            ...
            <div class="px-4 py-5 my-5 text-center">
              <img class="d-block mx-auto mb-4" src="https://dcf-playerscard.s3.us-east-2.amazonaws.com/assets/baby.svg" alt="" width="72" height="57" />
