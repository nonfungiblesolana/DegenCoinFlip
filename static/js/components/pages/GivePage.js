...
import { donate, getDonationPosts } from "../../api/donations.service";
import { getNonce } from "../../api/degen.service";
import { getBalance, signMessage } from "../../api-smart-contracts/dcf";
...
export const GivePage = ({ wallet, setPage, style, profileImageUrl, nickname, authToken, onConfetti }) => {
            ...
            <div className="play step2">
                <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between pb-3 py-sm-3 mb-4 border-bottom">
                    ...
                    <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                        ...
                        <img src="https://flagicons.lipis.dev/flags/4x3/ua.svg" height="32px" className="ms-2"></img>
                    </ul>
                ...
                <div className="bountiful-container">
                    <img className="bountiful-logo" src="https://i.imgur.com/3e4TfaB.png"></img>
                </div>
                <div className="mt-3">
                                ...
                                }
                                {
                                    ...
                                    <>
                                        <div className="d-inline-block">
                                            ...
                                            tx?.length > 0 &&
                                            <h6 className="mt-2">
                                                <a href={`https://solscan.io/tx/${tx}`} target="_blank">View on Solscan</a>
                                                <a href={`https://solscan.io/tx/${tx}`} target="_blank"><i className="ms-2 fa-solid fa-sm fa-up-right-from-square"></i></a>
                                            </h6>
                                        }
                                    </>
                                }
                    ...
                    <h5 className="my-4">Together we can be degens for good. We've donated over $18,000. <br/>100% of all donations will go to helping our friends in&nbsp;
                        <a href="https://donate.thedigital.gov.ua/" target="_blank">Ukraine</a>&nbsp;
                        <a href="https://donate.thedigital.gov.ua/" target="_blank"><i className="fa-solid fa-sm fa-up-right-from-square"></i></a>&nbsp;
                        <a href="https://donate.thedigital.gov.ua/" target="_blank"><img src="https://flagicons.lipis.dev/flags/4x3/ua.svg" height="17px" className="mb-1"></img></a>
                        .
                    </h5>
                </div>
                <ul className="nav nav-tabs mt-5">
                    <li className="nav-item">
                        <a className={"nav-link cursor-pointer" + (selectedTab == "SPONSOR" ? " active" : " text-secondary")} aria-current="page" onClick={() => handleSelectSponsorTab()}><h4 className="mb-0">SPONSORS</h4></a>
                    </li>
                    <li className="nav-item">
                        <a className={"nav-link cursor-pointer" + (selectedTab == "DONOR" ? " active" : " text-secondary")} onClick={() => handleSelectDonorTab()}><h4 className="mb-0">DONORS<small> (0.05 & UP)</small></h4></a>
                    </li>
                </ul>
                {
