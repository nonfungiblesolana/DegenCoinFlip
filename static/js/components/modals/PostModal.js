...
import { donate } from "../../api/donations.service";
                ...
                <div className="card">
                    <div className="card-body px-4 pt-4 pb-1">
                            ...
                            <div className="d-flex flex-column p-4 text-shadow-1">
                                <ul className="d-flex list-unstyled mt-auto mb-0">
                                    ...
                                    <li className="d-flex align-items-center me-auto">
                                        ...
                                        {
                                            twitter?.length > 0 &&
                                            <a href={`https://twitter.com/${twitter}`} target="_blank"><i className="fa-brands fa-sm fa-twitter ms-2"></i></a>
                                        }
                                    </li>
                                </ul>
                        ...
                        <p className="mb-0 mt-3 d-flex">
                            {
                                !hideAmount && 
                                <small className="ms-auto">Hide amount? click <a href="javascript:;" onClick={() => setHideAmount(true)}>here</a>.</small>
                            }
                            {
                                hideAmount && 
                                <small className="ms-auto">Show amount? click <a href="javascript:;" onClick={() => setHideAmount(false)}>here</a>.</small>
                            }
                        </p>
                    </div>
                </div>
